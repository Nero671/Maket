              ...
              <div class="col-12 col-lg-5">
                <div class="header-adress header-adress_email justify-content-center">
                  ...
                  <div class="header-adress__text header-mail__text">
                    <a href="mailto:info@maketstorent.ru"><?php the_field('email', 2) ?></a>
                  </div>
                  <!-- /.adress-text -->
                </div>
              </div>
          ...
          <div class="col-7 col-sm-4 col-lg-3">
            <div class="header-contacts">
              <div class="header-contacts__phone">
                <a href="tel:+7(495)008-55-77"><?php the_field('phone', 2) ?></a>
              </div>
        ...
        <div class="row justify-content-md-center justify-content-xl-between align-items-lg-center">
              ...
              <div class="advantages-blocks">
                <div class="row">
                  <div class="col-12 col-md-6">
                    <div class="advantages-block">
                      <div class="advantages-block__img">
                        <img src="<?php the_field('maket_img', 2); ?>" alt="">
                      </div>
                    ...
                    <div class="advantages-block">
                      <div class="advantages-block__img">
                        <img src="<?php the_field('materials_img', 2); ?>" alt="">
                      </div>
                      <!-- /.advantages-block__img -->
                      <div class="advantages-block__text">
                    ...
                    <div class="advantages-block">
                      <div class="advantages-block__img">
                        <img src="<?php the_field('discounts_img', 2); ?>" alt="">
                      </div>
                      <!-- /.advantages-block__img -->
                      <div class="advantages-block__text">
                        <?php the_field('discounts', 2) ?>
                      </div>
                      <!-- /.advantages-block__text -->
                    </div>
                    <!-- /.advantages-block -->
                  ...
                  <div class="col-12 col-md-6">
                    <div class="advantages-block">
                      <div class="advantages-block__img">
                        <img src="<?php the_field('quality_img', 2); ?>" alt="">
                      </div>
                      <!-- /.advantages-block__img -->
                      <div class="advantages-block__text">
                        <?php the_field('quality', 2) ?>
                      </div>
                      <!-- /.advantages-block__text -->
                    </div>
                    <!-- /.advantages-block -->
                    <div class="advantages-block">
                      <div class="advantages-block__img">
                        <img src="<?php the_field('deliverymoscow_img', 2); ?>" alt="">
                      </div>
                      <!-- /.advantages-block__img -->
                      <div class="advantages-block__text">
                        <?php the_field('moscowdelivery', 2) ?>
                      </div>
                      <!-- /.advantages-block__text -->
                    </div>
                    <!-- /.advantages-block -->
                    <div class="advantages-block advantages-block_last">
                      <div class="advantages-block__img">
                        <img src="<?php the_field('fastdelivery_img', 2); ?>" alt="">
                      </div>
                      <!-- /.advantages-block__img -->
                      <div class="advantages-block__text">
          ...
          <div class="col-12 col-md-10 col-lg-5 col-xl-4">
            <div class="form-main form">
              ...
              <!-- /.form-title -->
              <?php echo do_shortcode('[contact-form-7 id="178" title="main-form"]') ?>
    ...
    <div class="container">
      ...
      <div class="slider">
        ...
        ?>
            <div class="slider-block">
              <div class="slider-block__img">
                <img src="<?php the_field('instrument_img'); ?>" alt="">
              </div>
              <!-- /.slider-slider__img -->
              <div class="slider-block__name">
                <?php the_title(); ?>
      ...
      <div class="container">
        <div class="row">
          <div class="col-12 col-lg-3">
            <div class="manual-block">
              <div class="manual-block__img">
                <img src="<?php the_field('firststep_img', 2); ?>" alt="">
              </div>
              <!-- /.manual-img -->
              <div class="manual-block__text">
                <?php the_field('firststep', 2) ?>
                <div class="manual-block__text_order  show-order">
                  <?php the_field('firststep_link', 2) ?>
                </div>
              </div>
              <!-- /.manual-text -->
            </div>
          ...
          <div class="col-12 col-lg-3">
            <div class="manual-block">
              <div class="manual-block__img">
                <img src="<?php the_field('thirdstep_img', 2) ?>" alt="">
              </div>
              <!-- /.manual-img -->
              <div class="manual-block__text">
                <?php the_field('thirdstep', 2) ?>
                <div class="manual-block__text_order  show-order">
                  <?php the_field('thirdsstep_link', 2) ?>
                </div>
              </div>
              <!-- /.manual-text -->
            </div>
          ...
          <div class="col-12 col-lg-3">
            <div class="manual-block manual-block_last">
              <div class="manual-block__img">
                <img src="<?php the_field('fourthstep_img', 2) ?>" alt="">
              </div>
              <!-- /.manual-img -->
              <div class="manual-block__text">
                <?php the_field('fourthstep', 2) ?>
              </div>
              <!-- /.manual-text -->
            </div>
            <!-- /.manual-block -->
    ...
    <div class="container">
      <div class="row">
        <div class="col-12 col-md-6 col-xl-3">
          <div class="delivery-block">
            <div class="delivery-block__img">
              <img src="<?php the_field('free_img', 2); ?>" alt="">
            </div>
            <!-- /.delivery-block__img -->
            <div class="delivery-block__text">
              <?php the_field('free', 2); ?> <span><?php the_field('free_bold', 2); ?></span>
            </div>
        ...
        <div class="col-12 col-md-6 col-xl-3">
          <div class="delivery-block">
            <div class="delivery-block__img">
              <img src="<?php the_field('money_img', 2); ?>" alt="">
            </div>
            <!-- /.delivery-block__img -->
            <div class="delivery-block__text">
              Доставка <span><?php the_field('money_bold', 2); ?></span> <?php the_field('money', 2); ?>
            </div>
            <!-- /.delivery-block__text -->
          </div>
          <!-- /.delivery-block -->
        ...
        <div class="col-12 col-md-6 col-xl-3">
          <div class="delivery-block delivery-block_last1">
            <div class="delivery-block__img">
              <img src="<?php the_field('regions_img', 2); ?>" alt="">
            </div>
            <!-- /.delivery-block__img -->
            <div class="delivery-block__text">
              <span><?php the_field('regions_bold', 2); ?></span> <?php the_field('regions', 2); ?>
            </div>
            <!-- /.delivery-block__text -->
          </div>
          <!-- /.delivery-block -->
        ...
        <div class="col-12 col-md-6 col-xl-3">
          <div class="delivery-block delivery-block_last2">
            <div class="delivery-block__img">
              <img src="<?php the_field('pickup_img', 2); ?>" alt="">
            </div>
            <!-- /.delivery-block__img -->
            <div class="delivery-block__text">
              <span><?php the_field('pickup_bold', 2); ?></span> <br>
              <?php the_field('pickup', 2); ?>
            </div>
            <!-- /.delivery-block__text -->
          </div>
          <!-- /.delivery-block -->
        ...
        <div class="row justify-content-center">
          <div class="col-12 col-md-3">
            <div class="contacts-block">
              ...
              <div class="contacts-block__text">
                <a href="mailto:storent@maketstorent.ru"><?php the_field('email', 2) ?></a>
              </div>
          ...
          <div class="col-12 col-md-3">
            <div class="contacts-block contacts-block_last">
              ...
              <!-- /.contacts-block__img -->
              <div class="contacts-block__text">
                пн-вс <?php the_field('work_time', 2) ?>
              </div>
              <!-- /.contacts-block__text -->
            </div>
            <!-- /.contacts-block -->
